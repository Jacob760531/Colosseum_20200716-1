...
//        의견 좋아요 / 싫어요
        fun postRequestReplyLickOrDislike(context: Context, replyid : Int,isLike : Boolean, handler: JsonResponseHandler?) {
...
//        답글남기기
        fun postRequestReReply(context: Context, topicId: Int, content:String, handler: JsonResponseHandler?) {
